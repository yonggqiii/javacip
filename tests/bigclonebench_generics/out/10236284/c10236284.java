class c10236284 {
    ...
    public HashSet<String> queryResource(String resourceName, String propertyName) {
        ...
        String select = JavaCIPUnknownScope.prefix + " SELECT ?hasValue WHERE { { " + "<http://dbpedia.org/resource/" + resourceName + "> " + propertyName + " ?hasValue  } FILTER (lang(?hasValue) = \"" + JavaCIPUnknownScope.lang + "\" || !isLiteral(?hasValue))}";
