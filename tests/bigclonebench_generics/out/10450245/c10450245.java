class c10450245 {
    ...
    public Map<String, String> getMetadata(WebFileObject fo) throws IOException {
        if (!fo.wfs.getRootURL().getProtocol().equals("ftp")) {
            ...
            result.put(JavaCIPUnknownScope.META_EXIST, String.valueOf(exists));
            connect.disconnect();
            return result;
        } else {
            Map<String, String> result = new HashMap<String, String>();
            ...
            try {
                ...
                result.put(JavaCIPUnknownScope.META_EXIST, "true");
            } catch (IOException ex) {
                result.put(JavaCIPUnknownScope.META_EXIST, "false");
            }
            return result;
        }
    }
