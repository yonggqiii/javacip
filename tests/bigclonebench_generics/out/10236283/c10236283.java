class c10236283 {
    ...
    public MultiValueMap<String> queryResource(String resourceName) {
        ...
        String select = JavaCIPUnknownScope.prefix + " SELECT ?property ?hasValue WHERE { { " + "<http://dbpedia.org/resource/" + resourceName + "> ?property ?hasValue  } FILTER (lang(?hasValue) = \"" + JavaCIPUnknownScope.lang + "\" || !isLiteral(?hasValue))}";
