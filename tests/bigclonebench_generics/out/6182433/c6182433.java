class c6182433 {
    ...
    public String calculateProjectMD5(String scenarioName) throws Exception {
        ...
        String scenarioMD5 = JavaCIPUnknownScope.calculateScenarioMD5(s);
        Map<ProjectComponent, String> map = JavaCIPUnknownScope.getProjectMD5(new ProjectComponent[] { ProjectComponent.resources, ProjectComponent.classes, ProjectComponent.suts, ProjectComponent.libs });
