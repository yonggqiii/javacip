class c15301114 {
    ...
    public void updateFailedStatus(THLEventStatus failedEvent, ArrayList<THLEventStatus> events) throws THLException {
        ...
        try {
            ...
            pstmt.setString(2, JavaCIPUnknownScope.truncate(failedEvent.getException() != null ? failedEvent.getException().getMessage() : "Unknown failure", JavaCIPUnknownScope.commentLength));
