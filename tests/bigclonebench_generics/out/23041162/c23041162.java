class c23041162 {
    ...
    public void testJTLM_publish911() throws Exception {
        EXISchema corpus = EXISchemaFactoryTestUtil.getEXISchema("/JTLM/schemas/TLMComposite.xsd", this.getClass(), JavaCIPUnknownScope.m_compilerErrors);
        Assert.assertEquals(0, JavaCIPUnknownScope.m_compilerErrors.getTotalCount());
        ...
        URL url = JavaCIPUnknownScope.resolveSystemIdAsURL("/JTLM/publish911.xml");
