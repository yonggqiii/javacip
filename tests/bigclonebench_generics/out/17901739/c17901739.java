class c17901739 {
    ...
    private static void setMembers() {
        try {
            URL url = new URL(JavaCIPUnknownScope.getTracUrl() + "newticket");
            ...
            while (buffer != null) {
                if (buffer.contains("<select id=\"component\" name=\"component\">")) {
                    ...
                    JavaCIPUnknownScope.m_strComponents = new String[erg.size()];
                    erg.toArray(JavaCIPUnknownScope.m_strComponents);
                }
                if (buffer.contains("<select id=\"priority\" name=\"priority\">")) {
                    ...
                    JavaCIPUnknownScope.m_strPriorities = new String[erg.size()];
                    erg.toArray(JavaCIPUnknownScope.m_strPriorities);
                }
