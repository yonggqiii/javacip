class c5907854 {
    ...
    public List<String> getNamedEntitites(String sentence) {
        ...
        try {
            URL url = new URL(JavaCIPUnknownScope.SERVICE_URL + "text=" + URLEncoder.encode(sentence, "UTF-8") + "&confidence=" + JavaCIPUnknownScope.CONFIDENCE + "&support=" + JavaCIPUnknownScope.SUPPORT);
