class c8515619 {
    ...
    public ResponseStatus submit(Collection<SubmissionData> data) throws IOException {
        ...
        for (SubmissionData submissionData : data) {
            builder.append(submissionData.toString(JavaCIPUnknownScope.sessionId, index));
            builder.append('\n');
            index++;
        }
        ...
        HttpURLConnection urlConnection = Caller.getInstance().openConnection(JavaCIPUnknownScope.submissionUrl);
