        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (line.indexOf("binding name=\"" + sVar1 + "\"") != -1) {
                    ...
                    String s1 = JavaCIPUnknownScope.getURI(line);
                    if (s1 != null) {
                        s1 = JavaCIPUnknownScope.checkURISyntax(s1);
                ...
                if (line.indexOf("binding name=\"" + sVar2 + "\"") != -1) {
                    ...
                    String s2 = JavaCIPUnknownScope.getURI(line);
                    if (s2 != null) {
                        s2 = JavaCIPUnknownScope.checkURISyntax(s2);
