class c18544890 {
    ...
    public static GameRecord[] get(String url, float lat, float lon, int count) {
        try {
            ...
            req.setRequestProperty(GameRecord.GAME_LATITUDE_HEADER, JavaCIPUnknownScope.df.format(lat));
            req.setRequestProperty(GameRecord.GAME_LONGITUDE_HEADER, JavaCIPUnknownScope.df.format(lon));
