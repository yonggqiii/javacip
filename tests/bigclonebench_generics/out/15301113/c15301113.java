        ...
        try {
            ...
            if (skippedEvents != null && skippedEvents.size() > 0) {
                ...
                for (THLEventStatus event : skippedEvents) {
                    ...
                    pstmt.setString(2, JavaCIPUnknownScope.truncate(event.getException() != null ? event.getException().getMessage() : "Unknown event failure", JavaCIPUnknownScope.commentLength));
