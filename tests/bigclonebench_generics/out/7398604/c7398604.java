class c7398604 {
    ...
    public Collection<IAuthor> doImport() throws Exception {
        JavaCIPUnknownScope.progress.initialize(2, "Ściągam autorów amerykańskich");
        ...
        JavaCIPUnknownScope.progress.advance("Parsuję autorów amerykańskich");
        ...
        JavaCIPUnknownScope.progress.advance("Wykonano");
        return authors;
    }
}
