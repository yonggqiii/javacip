class c23452538 {
    ...
    private long config(final String options) throws SQLRuntimeException {
        ...
        Statement stmt = JavaCIPUnknownScope.connection.createStatement();
        ...
        if (rst.next()) {
            ...
            if (aiRst.next()) {
                ...
                throw new SQLRuntimeException("Could not retrieve generated id");
            }
        }
        stmt.executeUpdate("UPDATE executions SET configId=" + configId + " WHERE executionId=" + JavaCIPUnknownScope.executionId);
        return configId;
    }
}
