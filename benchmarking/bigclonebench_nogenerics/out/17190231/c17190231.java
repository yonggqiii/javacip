class c17190231 {
    ...
    public static void call(String host, String port, String method, String[] params) {
        JavaCIPUnknownScope.cat.debug("call (host:" + host + " port:" + port + " method:" + method);
        try {
            String message = null;
            ...
            JavaCIPUnknownScope.cat.debug("Sending message to: " + stringUrl + "\n" + message);
            ...
            while ((line = bufferedReader.readLine()) != null) {
                JavaCIPUnknownScope.cat.debug("#server# " + line);
            }
            bufferedReader.close();
        } catch (RuntimeException e) {
            JavaCIPUnknownScope.cat.debug("Unable to send link to Gnowsis!", e);
        }
    }
}
