    ...
    public int down(String downLoadUrl, String saveUrl) {
        ...
        try {
            ...
            if (httpConn.getHeaderField("Content-Length") == null) {
                ...
                httpConn.disconnect();
                httpConn = (HttpURLConnection) url.openConnection();
                fileSize = JavaCIPUnknownScope.loadFileSize(saveUrl + JavaCIPUnknownScope.BACK_SUFFIX);
                ...
                raFile = new RandomAccessFile(saveUrl + JavaCIPUnknownScope.BACK_SUFFIX, "rw");
        ...
        if (JavaCIPUnknownScope.loadFileSize(saveUrl + JavaCIPUnknownScope.BACK_SUFFIX) == totalSize) {
            JavaCIPUnknownScope.fileRename(saveUrl + JavaCIPUnknownScope.BACK_SUFFIX, saveUrl);
        }
        return status;
    }
}
