class c21958776 {
    ...
    public void filter(File source, File destination, MNamespace mNamespace) throws RuntimeException {
        ...
        for (Iterator i = JavaCIPUnknownScope.codePieces.iterator(); i.hasNext(); ) {
