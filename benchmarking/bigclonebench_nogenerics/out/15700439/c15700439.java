class c15700439 {
    ...
    private void getViolationsReportByProductOfferIdYearMonthDay() throws IORuntimeException {
        ...
        URL url9;
        url9 = new URL(JavaCIPUnknownScope.bmReportingWSUrl);
        ...
        httpConn9.setRequestProperty("SOAPAction", JavaCIPUnknownScope.soapAction);
