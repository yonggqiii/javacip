class c5636184 {
    ...
    public static Element postMessage() throws RuntimeException {
        final URL theUrl = JavaCIPUnknownScope.getHostURL();
        JavaCIPUnknownScope.lf.debug("url = " + theUrl.toExternalForm());
        ...
        JavaCIPUnknownScope.lf.debug("Received XML response from server: " + baos.toString());
