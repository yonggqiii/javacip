class c8181418 {
    ...
    public static final byte[] getBytesFromUrl(final String urlString) throws BT747RuntimeException {
        ...
        try {
            ...
            urlc.setConnectTimeout(JavaCIPUnknownScope.timeout);
            urlc.setReadTimeout(JavaCIPUnknownScope.timeout);
            ...
            throw new BT747RuntimeException(JavaCIPUnknownScope.I18N.i18n("Problem downloading AGPS data."), e);
        }
        return result;
    }
}
