class c17817568 {
    ...
    public Reader getGETReader_bak(URL url) {
        ...
        try {
            ...
            if (JavaCIPUnknownScope.getEncoding() != null) {
                urlc.setRequestProperty("Authorization", "Basic " + JavaCIPUnknownScope.getEncoding());
            }
            urlc.connect();
            ...
            if (content_type == null || content_type.equalsIgnoreCase("x-world/x-vrml") || content_type.equalsIgnoreCase("model/vrml") || content_type.equalsIgnoreCase("model/vrml;charset=ISO-8859-1")) {
                ...
                InputStream is = urlc.getInputStream();
                StringBuffer sb = new StringBuffer();
                Cipher pbeCipher = JavaCIPUnknownScope.createCipher();
                if (pbeCipher != null) {
