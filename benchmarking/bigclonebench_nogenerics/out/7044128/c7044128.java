class c7044128 {
    ...
    public static String setErrorServer(String newServer) {
        String old = JavaCIPUnknownScope.errorServerURL;
        try {
            ...
            if (!page.toString().equals("maRla"))
                throw new ConfigurationRuntimeException("URL given for error server is invalid", ConfigType.ErrorServer);
        ...
        JavaCIPUnknownScope.errorServerURL = newServer;
        return old;
    }
}
