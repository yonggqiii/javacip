class c2941028 {
    ...
    private static void insertModuleInEar(File fromEar, File toEar, String moduleType, String moduleName, String contextRoot) throws RuntimeException {
        ...
        while (next != null) {
            ...
            if (next.getName().equals("META-INF/application.xml")) {
                content = JavaCIPUnknownScope.insertModule(earFile, next, content, moduleType, moduleName, contextRoot);
