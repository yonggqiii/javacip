class c9665214 {
    ...
    public void testConvert() throws IORuntimeException, ConverterRuntimeException {
        ...
        Converter c = JavaCIPUnknownScope.context.getConverter("ddb-intern", "MARC21-xml", "x-PICA", "UTF-8");
