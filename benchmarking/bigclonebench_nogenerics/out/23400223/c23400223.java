class c23400223 {
    ...
    public void update(Channel channel) throws RuntimeException {
        ...
        try {
            ...
            String[] selfDefinePath = JavaCIPUnknownScope.getSelfDefinePath(path, exp, connection, preparedStatement, resultSet);
            JavaCIPUnknownScope.selfDefineDelete(selfDefinePath, connection, preparedStatement);
            JavaCIPUnknownScope.selfDefineAdd(selfDefinePath, channel, connection, preparedStatement);
            ...
            connection.rollback();
            JavaCIPUnknownScope.log.error("����Ƶ��ʧ�ܣ�channelPath=" + channel.getPath());
            throw ex;
        } finally {
