class c3167464 {
    ...
    public void adicionaCliente(ClienteBean cliente) {
        ...
        try {
            pstmt = JavaCIPUnknownScope.connection.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS);
            ...
            try {
                ...
                throw new RuntimeRuntimeException("Erro ao inserir cliente.", ex1);
            }
            throw new RuntimeRuntimeException("Erro ao inserir cliente.", ex);
        } finally {
            try {
                if (rs != null)
                    rs.close();
