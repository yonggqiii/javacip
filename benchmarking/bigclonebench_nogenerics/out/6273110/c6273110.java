class c6273110 {
    ...
    public void addStadium(Stadium stadium) throws StadiumRuntimeException {
        ...
        if (JavaCIPUnknownScope.findStadiumBy_N_C(stadium.getName(), stadium.getCity()) != -1)
            throw new StadiumRuntimeException("Stadium already exists");
        try {
            ...
            stm.executeUpdate();
            int id = JavaCIPUnknownScope.getMaxId();
