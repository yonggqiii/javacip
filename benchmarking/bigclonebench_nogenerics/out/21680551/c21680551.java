class c21680551 {
    ...
    private static File createTempWebXml(Class portletClass, File portletDir, String appName, String portletName) throws IORuntimeException, FileNotFoundRuntimeException {
        ...
        PortletUnitWebXmlStream streamSource = JavaCIPUnknownScope.WEB_XML_STREAM_FACTORY;
