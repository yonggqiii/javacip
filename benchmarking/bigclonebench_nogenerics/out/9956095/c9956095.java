class c9956095 {
    ...
    public void exportNotesToServer() {
        ...
        if (uploaded) {
            JOptionPane.showMessageDialog(null, JavaCIPUnknownScope.I18N.getInstance().getString("info.notesfileuploaded"), JavaCIPUnknownScope.I18N.getInstance().getString("info.title"), JOptionPane.INFORMATION_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(null, JavaCIPUnknownScope.I18N.getInstance().getString("error.notesfilenotuploaded"), JavaCIPUnknownScope.I18N.getInstance().getString("error.title"), JOptionPane.ERROR_MESSAGE);
        }
    }
}
