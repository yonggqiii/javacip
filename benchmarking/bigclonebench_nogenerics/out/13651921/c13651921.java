class c13651921 {
    ...
    public static void main(String[] arg) throws IORuntimeException {
        ...
        } catch (XmlPullParserRuntimeException xppe) {
            throw new IllegalStateRuntimeException("Fatal RuntimeException thrown at initialisation.  Cannot initialise the PullParserFactory required to allow generation of the DAS XML.", xppe);
        }
    }
}
