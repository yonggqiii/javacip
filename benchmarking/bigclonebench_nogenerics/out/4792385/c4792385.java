class c4792385 {
    ...
    private void upgradeSchema() {
        ...
        try {
            ...
            while (i < JavaCIPUnknownScope.SCHEMA_VERSION) {
                ...
                switch(i) {
                    case 0:
                        ...
                        stmt.executeUpdate(qry);
                        JavaCIPUnknownScope.updateFilesTable();
                        break;
                    case 1:
                    ...
                    case 11:
                        ...
                        try {
                            ...
                            pstmt = JavaCIPUnknownScope.conn.prepareStatement("REPLACE INTO settings (var, val) VALUES ('password', ?)");
            ...
            } catch (SQLRuntimeException x) {
                JavaCIPUnknownScope.LOG.fatal("SQL error", x);
            }
            JavaCIPUnknownScope.LOG.fatal("SQL error", e);
