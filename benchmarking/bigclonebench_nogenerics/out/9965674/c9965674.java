        ...
        try {
            ...
            if (result != null) {
                ...
                if (ss.startsWith("WHAT IS ")) {
                    ...
                    try {
                        String str = JavaCIPUnknownScope.getResultStr("http://www.google.com/search?hl=en&q=define%3A" + toSearch);
                        str = JavaCIPUnknownScope.cutAfter(str, "on the Web");
                        str = JavaCIPUnknownScope.cutAfter(str, "<li>");
                        str = JavaCIPUnknownScope.getBefore(str, "<br>");
