class c1008324 {
    ...
    public void copyHashAllFilesToDirectory(String baseDirStr, Hashtable newNamesTable, String destDirStr) throws RuntimeException {
        ...
        if ((baseDir.exists()) && (baseDir.isDirectory())) {
            if (!newNamesTable.isEmpty()) {
                ...
                while (enumFiles.hasMoreElements()) {
                    ...
                    if ((newName != null) && (!"".equals(newName)) && (oldPathName != null) && (!"".equals(oldPathName))) {
                        String newPathFileName = destDirStr + JavaCIPUnknownScope.sep + newName;
                        String oldPathFileName = baseDirStr + JavaCIPUnknownScope.sep + oldPathName;
                        if (oldPathName.startsWith(JavaCIPUnknownScope.sep)) {
            ...
            throw new RuntimeException("Base (baseDirStr) dir not exist !");
        }
    }
}
