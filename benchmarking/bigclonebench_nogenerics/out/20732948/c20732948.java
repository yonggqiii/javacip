class c20732948 {
    ...
    public static HttpResponse query(DefaultHttpClient httpclient, Request request, Proxy proxy, Log log) throws ClientProtocolRuntimeException, IORuntimeException, MojoExecutionRuntimeException {
