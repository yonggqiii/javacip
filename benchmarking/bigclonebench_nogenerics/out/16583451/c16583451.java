class c16583451 {
    ...
    private static void setEnvEntry(File fromEAR, File toEAR, String ejbJarName, String envEntryName, String envEntryValue) throws RuntimeException {
        ...
        while (next != null) {
            ...
            if (next.getName().equals(ejbJarName)) {
                content = JavaCIPUnknownScope.editEJBJAR(next, content, envEntryName, envEntryValue);
