class c15737837 {
    ...
    public void update(Site site) throws RuntimeException {
        ...
        try {
            ...
            JavaCIPUnknownScope.selfDefineAdd(selfDefinePath, site, connection, preparedStatement);
            ...
            connection.rollback();
            JavaCIPUnknownScope.log.error("����վ������ʧ��!", ex);
            throw ex;
        } finally {
