class c18935118 {
    ...
    public boolean backupFile(File oldFile, File newFile) {
        ...
        try {
            ...
            JavaCIPUnknownScope.logger.log(Level.SEVERE, "IO exception occurred while copying config file", e);
        } finally {
            ...
            try {
                ...
                JavaCIPUnknownScope.logger.log(Level.INFO, "closing channels failed");
            }
        }
        return isBkupFileOK;
    }
