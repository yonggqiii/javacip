class c6790585 {
    ...
    private void sendToServer(String fichaID, String respostas) throws FileNotFoundRuntimeException, ParserConfigurationRuntimeException, SAXRuntimeException, IORuntimeException, URISyntaxRuntimeException {
        ...
        request.setEntity(new UrlEncodedFormEntity(params, JavaCIPUnknownScope.HTTP.UTF_8));
        ...
        JavaCIPUnknownScope.backToMain();
    }
}
