class c14504556 {
    ...
    public void doNew(Vector userId, String shareFlag, String folderId) throws AddrRuntimeException {
        ...
        ResultSet rset = null;
        String sql = "insert into " + JavaCIPUnknownScope.SHARE_TABLE + " values(?,?,?)";
        try {
            ...
            JavaCIPUnknownScope.logger.error("���������ļ�����Ϣʧ��, " + ex.getMessage());
            throw new AddrRuntimeException("���������ļ�����Ϣʧ��,һ�������ļ���ֻ�ܹ����ͬһ�û�һ��!");
        } finally {
            JavaCIPUnknownScope.close(rset, null, ps, connection, dbo);
        }
    }
}
