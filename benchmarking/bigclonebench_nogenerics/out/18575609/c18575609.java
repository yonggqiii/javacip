class c18575609 {
    ...
    public void updateCoordinates(Address address) {
        ...
        if (JavaCIPUnknownScope.logger.isDebugEnabled()) {
            JavaCIPUnknownScope.logger.debug(location);
        }
        ...
        try {
            ...
            if (JavaCIPUnknownScope.logger.isDebugEnabled()) {
                JavaCIPUnknownScope.logger.debug("Error from google: " + e.getMessage());
            }
        }
        if (JavaCIPUnknownScope.logger.isDebugEnabled()) {
            JavaCIPUnknownScope.logger.debug(content);
        }
        ...
        if ((coordinates[0] != 0) || (coordinates[1] != 0)) {
            ...
            if (JavaCIPUnknownScope.logger.isDebugEnabled()) {
                JavaCIPUnknownScope.logger.debug("Invalid coordinates for address " + address.getId());
            }
        }
    }
}
