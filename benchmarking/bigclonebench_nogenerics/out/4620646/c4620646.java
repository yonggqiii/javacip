class c4620646 {
    ...
    public static int ToGSML(GeoSciML_Mapping mapping, String strTemplate, String strRequest, PrintWriter sortie, String requestedSRS) throws RuntimeException {
        String level = "info.";
        ...
        while ((strLine = buffin.readLine()) != null) {
            if (strLine.indexOf(tagFeature) != -1) {
                nbFeatures++;
                GSMLFeatureGeneric feature = JavaCIPUnknownScope.createGSMLFeatureFromGMLFeatureString(mapping, strLine);
