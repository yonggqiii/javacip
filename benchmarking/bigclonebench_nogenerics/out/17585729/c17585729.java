class c17585729 {
    ...
    private File sendQuery(String query) throws MusicBrainzRuntimeException {
        File xmlServerResponse = null;
        try {
            xmlServerResponse = new File(JavaCIPUnknownScope.SERVER_RESPONSE_FILE);
            ...
            if (e instanceof FileNotFoundRuntimeException) {
                msg = "ERROR: MusicBrainz URL used is not found:\n" + msg;
            } else {
            }
            throw new MusicBrainzRuntimeException(msg);
        }
