class c9980885 {
    ...
    private void verifyAvailability() {
        for (int i = 0; i < JavaCIPUnknownScope.servers.size(); i++) {
            String hostEntry = (String) JavaCIPUnknownScope.servers.get(i);
            ...
            if (JavaCIPUnknownScope.serverRequests.get(hostEntry) != null) {
                String requestData = (String) JavaCIPUnknownScope.serverRequests.get(hostEntry);
            ...
            try {
                ...
                JavaCIPUnknownScope.serverTimes.put(hostEntry, "0");
                continue;
            }
            try {
            ...
            JavaCIPUnknownScope.serverStatus.put(hostEntry, "1");
            ...
            JavaCIPUnknownScope.serverTimes.put(hostEntry, timeResponse);
        }
    }
}
