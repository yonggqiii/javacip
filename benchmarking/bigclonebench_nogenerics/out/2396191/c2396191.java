class c2396191 {
    ...
    public static Vector[] getLinksFromURLFast(String p_url) throws RuntimeException {
        JavaCIPUnknownScope.timeCheck("getLinksFromURLFast ");
        ...
        JavaCIPUnknownScope.timeCheck("starting parsing ");
        ...
        for (int i = 0; i < x_matches.length; i++) {
            ...
            if (x_link.indexOf("mailto:") != -1)
                continue;
            x_link = JavaCIPUnknownScope.toAbsolute(x_root, x_dir, x_link);
        ...
        x_result[0] = x_links;
        x_result[1] = x_texts;
        JavaCIPUnknownScope.timeCheck("end parsing ");
        return x_result;
    }
}
