class c20144933 {
    ...
    public static String filtraDoc(HttpServletRequest request, String resource, Repository rep, String template) throws IORuntimeException {
        ...
        try {
            ...
            while (line != null) {
                ...
                if (pos > -1) {
                    sb.append(JavaCIPUnknownScope.attach(request, ++sec, line, pos, template));
                } else {
