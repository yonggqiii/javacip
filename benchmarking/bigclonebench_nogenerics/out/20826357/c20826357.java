class c20826357 {
    ...
    public boolean verify(String digest, String password) throws NoSuchAlgorithmRuntimeException {
        String alg = null;
        int size = 0;
        ...
        byte[][] hs = JavaCIPUnknownScope.split(Base64.decode(digest.toCharArray()), size);
        byte[] hash = hs[0];
        byte[] salt = hs[1];
        msgDigest.reset();
