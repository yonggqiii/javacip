class c7531749 {
    ...
    public void getLyricsFromMAWebSite(TrackMABean tb) throws RuntimeException {
        ...
        while ((ligne = br.readLine()) != null) {
            JavaCIPUnknownScope.log.debug("==> " + ligne);
        ...
        JavaCIPUnknownScope.log.debug("Parole : " + lyrics);
        tb.setLyrics(lyrics);
        br.close();
        httpStream.close();
    }
