class c16713229 {
    ...
    public void uploadFile(ActionEvent event) throws IORuntimeException {
        InputFile inputFile = (InputFile) event.getSource();
        synchronized (inputFile) {
            ServletContext context = (ServletContext) FacesContext.getCurrentInstance().getExternalContext().getContext();
            String fileNewPath = JavaCIPUnknownScope.arrangeUplodedFilePath(context.getRealPath(""), inputFile.getFile().getName());
