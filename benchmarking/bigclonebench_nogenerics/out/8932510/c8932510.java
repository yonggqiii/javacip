class c8932510 {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IORuntimeException, ServletRuntimeException {
        InputStream is = null;
        ...
        try {
            ...
            JavaCIPUnknownScope.streamRuntimeException(request, response, e);
        } finally {
