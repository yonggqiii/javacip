class c20965286 {
    ...
    public void openAndClose(ZKEntry zke, LinkedList toOpen, LinkedList toRemove) throws SQLRuntimeException {
        JavaCIPUnknownScope.conn.setAutoCommit(false);
        try {
            Statement stm = JavaCIPUnknownScope.conn.createStatement();
            ...
            while (rset.next()) {
                ...
                Statement ust = JavaCIPUnknownScope.conn.createStatement();
