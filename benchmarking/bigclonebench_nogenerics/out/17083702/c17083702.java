class c17083702 {
    ...
    public void savaUserPerm(String userid, Collection user_perm_collect) throws DAORuntimeException, SQLRuntimeException {
        ...
        try {
            ...
            pstmt = conn.prepareStatement(JavaCIPUnknownScope.DEL_USER_PERM);
            ...
            if ((user_perm_collect == null) || (user_perm_collect.size() <= 0)) {
                ...
                pstmt = conn.prepareStatement(JavaCIPUnknownScope.ADD_USER_PERM);
