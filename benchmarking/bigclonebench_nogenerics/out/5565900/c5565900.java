class c5565900 {
    ...
    public Resource get(String serviceUrl, String resourceId, String svcId, boolean appendProfile) throws RuntimeException {
        ...
        String openurl = JavaCIPUnknownScope.getURL(serviceUrl, resourceId, svcId, appendProfile);
        JavaCIPUnknownScope.logger.debug("OpenURL Request: " + openurl);
        URL url;
        try {
            url = new URL(openurl);
            ...
            if (code == 200) {
                ...
                JavaCIPUnknownScope.logger.error("An error of type " + code + " occurred for " + url.toString());
