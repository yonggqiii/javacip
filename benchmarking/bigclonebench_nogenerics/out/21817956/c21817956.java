class c21817956 {
    ...
    public void moveNext(String[] showOrder, String[] orgID, String targetShowOrder, String targetOrgID) throws RuntimeException {
        Connection con = null;
        ...
        try {
            ...
            for (int j = 0; j < sqls.length; j++) {
                ...
                if (resultCount != 1) {
                    throw new CesSystemRuntimeException("Organize.moveNext(): ERROR Inserting data " + "in T_SYS_ORGANIZE update !! resultCount = " + resultCount);
                }
            }
            con.commit();
            ...
            throw new CesSystemRuntimeException("Organize.moveNext(): SQLRuntimeException while mov organize order " + " :\n\t" + se);
        } finally {
