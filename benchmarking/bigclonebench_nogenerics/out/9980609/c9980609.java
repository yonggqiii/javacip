class c9980609 {
    ...
    public static void copyResource(Resource source, Resource dest, FilterSetCollection filters, Vector filterChains, boolean overwrite, boolean preserveLastModified, boolean append, String inputEncoding, String outputEncoding, Project project) throws IORuntimeException {
        ...
        if (filterSetsAvailable) {
            ...
            try {
                ...
                OutputStream os = JavaCIPUnknownScope.getOutputStream(dest, append, project);
            ...
            if (parent != null && !parent.isDirectory() && !destFile.getParentFile().mkdirs()) {
                throw new IORuntimeException("failed to create the parent directory" + " for " + destFile);
            }
            ...
            try {
                ...
                out = JavaCIPUnknownScope.getOutputStream(dest, append, project);
        ...
        if (preserveLastModified) {
            ...
            if (t != null) {
                JavaCIPUnknownScope.setLastModified(t, source.getLastModified());
            }
        }
    }
}
