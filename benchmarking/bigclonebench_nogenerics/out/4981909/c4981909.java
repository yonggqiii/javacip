    ...
    public static File enregistrerFichier(String fileName, File file, String path, String fileMime) throws RuntimeException {
        if (file != null) {
            try {
                ...
                JavaCIPUnknownScope.logger.debug(" enregistrerFichier - Enregistrement du fichier : " + pathFile);
                FileChannel in = null;
                ...
                JavaCIPUnknownScope.logger.error("Erreur lors de l'enregistrement de l'image ", e);
