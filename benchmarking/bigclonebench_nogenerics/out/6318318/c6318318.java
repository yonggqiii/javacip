class c6318318 {
    ...
    public static void addReaderField(final String fieldName, final Document document, final Store store, final TermVector termVector, final Reader reader) throws RuntimeException {
        if (fieldName == null || reader == null) {
            JavaCIPUnknownScope.LOGGER.warn("Field and reader can't be null : " + fieldName + ", " + reader);
            return;
        }
        ...
        if (field == null) {
            ...
            try {
                ...
                JavaCIPUnknownScope.LOGGER.error("RuntimeException writing the field value with the file writer : ", e);
            } finally {
