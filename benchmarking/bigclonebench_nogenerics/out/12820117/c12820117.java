class c12820117 {
    ...
    static void invalidSlave(String msg, Socket sock) throws IORuntimeException {
        ...
        try {
            ...
            _sout.println(msg);
            JavaCIPUnknownScope.logger.info("NEW< " + msg);
            ...
            try {
                ...
                throw new IORuntimeException("Slave Inititalization Faailed");
            }
            String pass = sname + spass + JavaCIPUnknownScope._pass;
