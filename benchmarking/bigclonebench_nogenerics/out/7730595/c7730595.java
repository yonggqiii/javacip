class c7730595 {
    ...
    public void appendFetch(IProgress progress, PrintWriter pw, String list, int from, int to) throws IORuntimeException {
        progress.start();
        try {
            File storage = new File(JavaCIPUnknownScope.cacheDirectory.getValue(), "mboxes");
            storage.mkdirs();
            ...
            URL url = JavaCIPUnknownScope.getGmaneURL(list, from, to);
