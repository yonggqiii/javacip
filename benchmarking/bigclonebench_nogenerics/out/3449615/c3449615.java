class c3449615 {
    ...
    public ProgramMessageSymbol addProgramMessageSymbol(int programID, String name, byte[] bytecode) throws AdaptationRuntimeException {
        ...
        try {
            ...
            JavaCIPUnknownScope.log.info("INSERT INTO ProgramMessageSymbols(programID, name, " + "bytecode) VALUES (" + programID + ", '" + name + "', " + "<bytecode>)");
            ...
            programMessageSymbol = JavaCIPUnknownScope.getProgramMessageSymbol(resultSet);
            connection.commit();
