class c7122523 {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws RuntimeException {
        ...
        JavaCIPUnknownScope.log.debug("Tipo Mime: " + tipoMime);
        ...
        JavaCIPUnknownScope.log.debug("entra success");
