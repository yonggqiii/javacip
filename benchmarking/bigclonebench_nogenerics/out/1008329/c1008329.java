class c1008329 {
    ...
    public long copyFile(String baseDirStr, String fileName, String file2FullPath) throws RuntimeException {
        long plussQuotaSize = 0;
        if (!baseDirStr.endsWith(JavaCIPUnknownScope.sep)) {
            baseDirStr += JavaCIPUnknownScope.sep;
        }
        ...
        if (!file1FullPath.equalsIgnoreCase(file2FullPath)) {
            ...
            if (file1.exists() && (file1.isFile())) {
                ...
                throw new RuntimeException("Source file not exist ! file1FullPath = (" + file1FullPath + ")");
            }
        }
