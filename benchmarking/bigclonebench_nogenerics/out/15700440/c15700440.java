class c15700440 {
    ...
    private void getViolationsReportBySLATIdYearMonth() throws IORuntimeException {
        ...
        URL url10;
        url10 = new URL(JavaCIPUnknownScope.bmReportingWSUrl);
        ...
        httpConn10.setRequestProperty("SOAPAction", JavaCIPUnknownScope.soapAction);
