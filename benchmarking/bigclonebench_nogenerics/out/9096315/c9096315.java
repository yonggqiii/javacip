    ...
    private void handleInterfaceDown(long eventID, long nodeID, String ipAddr, String eventTime) {
        ...
        try {
            ...
            while (activeSvcsRS.next()) {
                ...
                if (JavaCIPUnknownScope.openOutageExists(dbConn, nodeID, ipAddr, serviceID)) {
                    if (log.isDebugEnabled())
                    ...
                    newOutageWriter.setTimestamp(6, JavaCIPUnknownScope.convertEventTimeIntoTimestamp(eventTime));
