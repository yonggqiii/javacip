class c21033686 {
    ...
    public File read() throws IORuntimeException {
        ...
        ProgressMonitor monitor = new ProgressMonitor(JavaCIPUnknownScope.parentComponent, "Downloading " + JavaCIPUnknownScope.url, null, 0, length);
        try {
