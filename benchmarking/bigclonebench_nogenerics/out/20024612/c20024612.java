class c20024612 {
    ...
    private void parse() throws RuntimeException {
        ...
        URL fileURL = new URL(JavaCIPUnknownScope.url);
        ...
        while ((ligne = br.readLine()) != null) {
            if (ligne.indexOf("div class=\"post\" id=\"post") != -1) {
                ...
                try {
                    ...
                    JavaCIPUnknownScope.log.info("Post   : " + post + " du " + date);
                    ligne = br.readLine();
                    ligne = br.readLine();
                    ...
                    JavaCIPUnknownScope.log.info("Titre  : " + titre);
                    JavaCIPUnknownScope.log.info("To DL  : " + url2DL);
                    ligne = br.readLine();
                    ligne = br.readLine();
                    ligne = br.readLine();
                    ligne = br.readLine();
                    ...
                    JavaCIPUnknownScope.log.info("Resume : " + resume);
                } catch (RuntimeException e) {
                    JavaCIPUnknownScope.log.error("ERREUR : Le film n'a pas pu etre parse...");
                }
