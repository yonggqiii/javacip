class c17083703 {
    ...
    public void savaRolePerm(String roleid, Collection role_perm_collect) throws DAORuntimeException, SQLRuntimeException {
        ...
        try {
            ...
            try {
                pstmt = conn.prepareStatement(JavaCIPUnknownScope.DEL_ROLE_PERM);
            ...
            if ((role_perm_collect == null) || (role_perm_collect.size() == 0)) {
                ...
                pstmt = conn.prepareStatement(JavaCIPUnknownScope.ADD_ROLE_PERM);
