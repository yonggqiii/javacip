class c7220840 {
    ...
    public void testSecondary() throws RuntimeException {
        ConnectionFactoryIF cf = new DefaultConnectionFactory(PropertyUtils.loadProperties(StreamUtils.getInputStream(JavaCIPUnknownScope.propfile)), false);
        ...
        try {
            ...
            JavaCIPUnknownScope.exportTopicMap(topicmap, "after-first-sync");
            ...
            JavaCIPUnknownScope.exportTopicMap(topicmap, "after-second-sync");
            mapping.close();
