class c23241194 {
    ...
    private void publishZip(LWMap map) {
        try {
            ...
            VueUtil.alert(JavaCIPUnknownScope.VUE.getDialogParent(), VueResources.getString("dialog.export.message") + ex.getMessage(), VueResources.getString("dialog.export.title"), JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
        }
    }
}
