class c5980224 {
    ...
    public static final TreeSet<String> getValues(String baseurl, String rftId, String svcId) {
        ...
        try {
            ...
            JavaCIPUnknownScope.log.error("UnsupportedEncodingRuntimeException resulted attempting to encode " + rftId);
        }
        String openurl = baseurl + "/" + fragments[2] + "/openurl-aDORe7" + "?rft_id=" + e_repoUri + "&svc_id=" + e_svcId + "&url_ver=Z39.88-2004";
        JavaCIPUnknownScope.log.info("Obtaining Content Values from: " + openurl);
        try {
            ...
            JavaCIPUnknownScope.log.info("Query Time: " + (System.currentTimeMillis() - s) + "ms");
            String line;
            ...
            JavaCIPUnknownScope.log.error("problem with openurl:" + openurl + ex.getMessage());
