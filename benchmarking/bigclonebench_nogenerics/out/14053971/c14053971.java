class c14053971 {
    ...
    private static String fetchUrl(String url, boolean keepLineEnds) throws IORuntimeException, MalformedURLRuntimeException {
        ...
        if (JavaCIPUnknownScope.proxyAuth != null)
            destConnection.setRequestProperty("Proxy-Authorization", JavaCIPUnknownScope.proxyAuth);
