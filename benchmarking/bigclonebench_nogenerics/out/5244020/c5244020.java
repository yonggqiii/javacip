class c5244020 {
    ...
    public static AddUserResponse napiUserAdd(String user, String pass, String email) throws TimeoutRuntimeException, InterruptedRuntimeException, IORuntimeException {
