class c19886663 {
    ...
    public boolean retrieveByPMID(String pmid) {
        try {
            URL url = new URL(JavaCIPUnknownScope.baseURL + "&id=" + pmid.trim());
            ...
            while ((line = xml.readLine()) != null) {
                if (line.indexOf("<ArticleTitle>") != -1) {
                    ...
                    PrintWriter article = new PrintWriter(new FileWriter(new File(JavaCIPUnknownScope.outputDir.getPath() + File.separatorChar + pmid + ".txt")));
