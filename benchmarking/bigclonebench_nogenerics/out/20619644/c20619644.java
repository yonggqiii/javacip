class c20619644 {
    ...
    private static void upload(String login, String password, String file) throws ApiRuntimeException {
        ...
        try {
            ...
            if (res.isEmpty()) {
                ...
                JavaCIPUnknownScope.downloadlink = da.getFileDownloadLink(login, password, newFileId);
