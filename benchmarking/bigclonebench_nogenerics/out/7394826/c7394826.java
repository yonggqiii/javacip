class c7394826 {
    ...
    public void process(HttpServletRequest request, HttpServletResponse response) throws ServletRuntimeException, IORuntimeException {
        if (request.getParameter("acao").equals("confirmar")) {
            String uuid = request.getParameter("uuid");
            PersistenceManager pm = JavaCIPUnknownScope.PMF.get().getPersistenceManager();
            ...
            RequestDispatcher dispatcher = JavaCIPUnknownScope.getServletContext().getRequestDispatcher(Pagina.PAGINA_APRESENTACAO);
            ...
            RequestDispatcher dispatcher = JavaCIPUnknownScope.getServletContext().getRequestDispatcher(Pagina.PAGINA_EMPRESA_CADASTRAR);
            dispatcher.forward(request, response);
            ...
            String uuid = JavaCIPUnknownScope.UUID.randomUUID().toString();
            ...
            RequestDispatcher dispatcher = JavaCIPUnknownScope.getServletContext().getRequestDispatcher(Pagina.PAGINA_MENU);
            dispatcher.forward(request, response);
            ...
            try {
                ...
                for (int temp = 0; temp < 3; temp++) {
                    ...
                    if (nNode.getNodeType() == Node.ELEMENT_NODE) {
                        ...
                        out.print(JavaCIPUnknownScope.getTagValue("title", eElement) + "<br/><br/>");
                    }
                }
