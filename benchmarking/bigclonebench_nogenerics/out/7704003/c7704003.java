class c7704003 {
    ...
    public void moveRowUp(int id, int row) throws FidoDatabaseRuntimeException {
        try {
            ...
            try {
                ...
                int max = JavaCIPUnknownScope.findMaxRank(stmt, id);
                if ((row < 2) || (row > max))
                    throw new IllegalArgumentRuntimeException("Row number not between 2 and " + max);
