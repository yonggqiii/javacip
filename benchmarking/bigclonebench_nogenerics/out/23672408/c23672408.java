class c23672408 {
    ...
    private void copyIconFiles(UmlClass clazz) {
        if (clazz.hasAnnotation("icon16")) {
            ...
            if (i16.endsWith(".gif"))
                fileType = ".gif";
            String desti16 = JavaCIPUnknownScope.output_dir + "/../resources/images/" + clazz.getName() + "16" + fileType;
            try {
        ...
        if (clazz.hasAnnotation("icon32")) {
            ...
            if (i32.endsWith(".gif"))
                fileType = ".gif";
            String desti32 = JavaCIPUnknownScope.output_dir + "/../resources/images/" + clazz.getName() + "32" + fileType;
            try {
