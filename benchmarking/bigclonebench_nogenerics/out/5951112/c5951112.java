    ...
    public static String getFileContents(String path) {
        ...
        if (path.indexOf("://") != -1) {
            ...
            try {
                ...
                JavaCIPUnknownScope.LOGGER.warn(String.format("Malformed URL: \"%s\"", path));
            }
            if (url == null) {
            ...
            try {
                ...
                JavaCIPUnknownScope.LOGGER.warn(String.format("I/O error trying to read \"%s\"", path));
            }
        } else {
            File toRead = null;
            try {
                toRead = JavaCIPUnknownScope.getExistingFile(path);
            ...
            if (toRead.isAbsolute()) {
                ...
                try {
                    JavaCIPUnknownScope.workingDirectory.push(URLTools.createValidURL(parent));
                } catch (FileNotFoundRuntimeException e) {
            ...
            if (toRead.exists() && !toRead.isDirectory()) {
                ...
                try {
                    ...
                    JavaCIPUnknownScope.LOGGER.warn(String.format("I/O error trying to read \"%s\"", _path));
                    return null;
                }
            } else {
