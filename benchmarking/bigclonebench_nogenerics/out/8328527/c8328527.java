class c8328527 {
    ...
    public void insertJobLog(String userId, String[] checkId, String checkType, String objType) throws RuntimeException {
        ...
        try {
            ...
            JavaCIPUnknownScope.log.debug((new Date().toString()) + " ������Ȩ��ʧ��! ");
            try {
                connection.rollback();
            ...
            JavaCIPUnknownScope.close(null, null, preStm, connection, dbo);
        }
    }
}
