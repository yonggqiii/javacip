class c2396189 {
    ...
    public static Vector getKeywordsFromURL(String p_url) throws RuntimeException {
        ...
        do {
            ...
            if (x_end != -1) {
                JavaCIPUnknownScope.extractOutsideText(x_line.substring(0, x_end), "<", ">", x_words, x_status);
                break;
            }
            x_status = JavaCIPUnknownScope.extractOutsideText(x_line, "<", ">", x_words, x_status);
        } while ((x_line = x_reader.readLine()) != null);
        return x_words;
    }
}
