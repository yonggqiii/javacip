    ...
    public static String callService(String urlString) throws NoItemRuntimeException, ServiceRuntimeException {
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                ByteBuffer buffer = JavaCIPUnknownScope.WWIO.readStreamToBuffer(inputStream);
                String charsetName = JavaCIPUnknownScope.getCharsetName(contentType);
                return JavaCIPUnknownScope.decodeBuffer(buffer, charsetName);
            ...
            Logging.logger().log(JavaCIPUnknownScope.java.util.logging.Level.SEVERE, msg);
            ...
            JavaCIPUnknownScope.WWIO.closeStream(inputStream, urlString);
        }
    }
}
