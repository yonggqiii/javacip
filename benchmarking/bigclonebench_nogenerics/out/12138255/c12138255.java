        ...
        try {
            ...
            while ((strLine = br.readLine()) != null) {
                ...
                if (!strLine.startsWith("\"")) {
                    ...
                    if (state == states.MSGCTXT) {
                        msgCtxt += JavaCIPUnknownScope.format(strLine);
                    }
                    if (state == states.MSGID) {
                        if (msgId.isEmpty()) {
                            if (!msgCtxt.isEmpty()) {
                        ...
                        msgId += JavaCIPUnknownScope.format(strLine);
                    }
                    if (state == states.MSGSTR) {
                        msgCtxt = "";
                        msgStr += JavaCIPUnknownScope.format(strLine);
                        if (!msgId.isEmpty())
                            JavaCIPUnknownScope.messages.setProperty(msgId, msgStr);
                    }
                }
            }
            in.close();
