class c17340376 {
    ...
    private static String fetchImageViaHttp(URL imgUrl) throws IORuntimeException {
        ...
        try {
            ...
            if (ctx != null)
                ...
                cnx.addRequestProperty("User-Agent", JavaCIPUnknownScope.user_agent);
            ...
            if (!Multimedia.isImageFile("aa." + ext))
                ext = "jpg";
            uri = JavaCIPUnknownScope.FMT_FN.format(new Date()) + RandomStringUtils.randomAlphanumeric(4) + '.' + ext;
            File fileDest = new File(JavaCIPUnknownScope.img_path + uri);
