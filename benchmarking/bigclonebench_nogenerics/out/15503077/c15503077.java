class c15503077 {
    ...
    private ArrayList execAtParentServer(ArrayList paramList) throws RuntimeException {
            ...
            while (it.hasNext()) {
                ...
                for (int i = 0; i < paramList.size(); i++) {
                    ...
                    if (i == 0) {
                        ...
                        buf.append("&upstream_size" + JavaCIPUnknownScope.upstreamSize);
                        buf.append("&downstreamSize" + JavaCIPUnknownScope.downstreamSize);
                        buf.append("&MARGIN_LENGTH=" + JavaCIPUnknownScope.marginLength);
                        buf.append("&OVERLAP_LENGTH=" + JavaCIPUnknownScope.overlapLength);
