class c4567361 {
    ...
    private Attachment setupSimpleAttachment(Context context, long messageId, boolean withBody) throws IORuntimeException {
        ...
        if (withBody) {
            InputStream inStream = new ByteArrayInputStream(JavaCIPUnknownScope.TEST_STRING.getBytes());
