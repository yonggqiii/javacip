class c18377054 {
    ...
    private void prepareUrlFile(ZipEntryRef zer, String nodeDir, String reportDir) throws RuntimeException {
        ...
        JavaCIPUnknownScope.logger.debug("download " + zer.getUri() + " in " + fcopyName);
