class c5808067 {
    ...
    public void action(String msg, String uri, Gateway gateway) throws RuntimeException {
        String city = "成都";
        if (msg.indexOf("#") != -1) {
        ...
        if (conn.getResponseCode() == 200) {
            ...
            String[] sugguestions = JavaCIPUnknownScope.getText(strings.get(6)).split("\n");
            StringBuffer buffer = new StringBuffer();
            buffer.append("欢迎使用MapleSMS的天气服务！\n");
            buffer.append("你查询的是 " + JavaCIPUnknownScope.getText(strings.get(1)) + "的天气。\n");
            buffer.append(JavaCIPUnknownScope.getText(strings.get(4)) + "。\n");
            buffer.append(JavaCIPUnknownScope.getText(strings.get(5)) + "。\n");
