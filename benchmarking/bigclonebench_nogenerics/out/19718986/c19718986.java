class c19718986 {
    ...
    public static void concatenateToDestFile(File sourceFile, File destFile) throws IORuntimeException {
        if (!destFile.exists()) {
            if (!destFile.createNewFile()) {
                throw new IllegalArgumentRuntimeException("Could not create destination file:" + destFile.getName());
            }
        }
