class c23264025 {
    ...
    private byte[] download(String URL) {
        ...
        try {
            ...
            HttpResponse response = JavaCIPUnknownScope.httpClient.execute(httpGet);
            ...
            if (pos >= 0) {
                JavaCIPUnknownScope.detectedEncoding = header.getValue().substring(pos + 8);
            }
            ...
            JavaCIPUnknownScope.LOG.warn("downloading error,abandon");
            result = null;
        }
        return result;
    }
