class c23273706 {
    ...
    public String[][] getProjectTreeData() {
        ...
        String filename = JavaCIPUnknownScope.dms_home + JavaCIPUnknownScope.FS + "temp" + JavaCIPUnknownScope.FS + JavaCIPUnknownScope.username + "adminprojects.xml";
        String urlString = JavaCIPUnknownScope.dms_url + "/servlet/com.ufnasoft.dms.server.ServerGetAdminProjects";
        try {
            String urldata = urlString + "?username=" + URLEncoder.encode(JavaCIPUnknownScope.username, "UTF-8") + "&key=" + URLEncoder.encode(JavaCIPUnknownScope.key, "UTF-8") + "&filename=" + URLEncoder.encode(JavaCIPUnknownScope.username, "UTF-8") + "adminprojects.xml";
