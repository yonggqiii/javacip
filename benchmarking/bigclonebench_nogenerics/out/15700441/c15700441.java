class c15700441 {
    ...
    private void getViolationsReportBySLATIdYearMonthDay() throws IORuntimeException {
        ...
        URL url11;
        url11 = new URL(JavaCIPUnknownScope.bmReportingWSUrl);
        ...
        httpConn11.setRequestProperty("SOAPAction", JavaCIPUnknownScope.soapAction);
