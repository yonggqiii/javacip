class c10158741 {
    ...
    public void moveRuleUp(String language, String tag, int row) throws FidoDatabaseRuntimeException {
        try {
            ...
            try {
                ...
                if ((row < 2) || (row > max))
                    throw new IllegalArgumentRuntimeException("Row number (" + row + ") was not between 2 and " + max);
