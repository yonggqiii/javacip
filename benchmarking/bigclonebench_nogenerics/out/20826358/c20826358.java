class c20826358 {
    ...
    public String generateDigest(String password, String saltHex, String algorithm) throws NoSuchAlgorithmRuntimeException {
        ...
        digest.append(Base64.encode(JavaCIPUnknownScope.concatenate(pwhash, salt)));
