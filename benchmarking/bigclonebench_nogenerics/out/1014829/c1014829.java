class c1014829 {
    ...
    public int readRaw(byte[] buffer, int offset, int length) throws IORuntimeException {
        ...
        int n = 0;
        try {
            connection = (HttpURLConnection) JavaCIPUnknownScope.url.openConnection();
            String byteRange = "bytes=" + JavaCIPUnknownScope.position + "-" + (JavaCIPUnknownScope.position + length - 1);
            ...
            JavaCIPUnknownScope.position += n;
            return n;
