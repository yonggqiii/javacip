class c6068118 {
    ...
    public byte[] exportCommunityData(String communityId) throws RepositoryRuntimeException, IORuntimeException {
        Community community;
        try {
            community = JavaCIPUnknownScope.getCommunityById(communityId);
        } catch (CommunityNotFoundRuntimeException e1) {
            throw new GroupwareRuntimeRuntimeException("Community to export not found");
        }
        ...
        try {
            ...
            JavaCIPUnknownScope.exportCommunitySystemView(community, contentPath, fos);
            fos.close();
            ...
            JavaCIPUnknownScope.log.error(errorMessage, e);
            throw new CMSRuntimeRuntimeException(errorMessage, e);
        }
    }
}
