class c547576 {
    ...
    public static void main(String[] argv) {
        ...
        try {
            ...
            if (!url.getProtocol().equals("http") || !url.getHost().equals("www.fsf.org") || url.getPort() != 80 || !url.getFile().equals("/"))
        ...
        try {
            ...
            if (!url.toString().equals("http://www.urbanophile.com/arenn/trans/trans.html#mis"))
