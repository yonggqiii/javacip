class c2198030 {
    ...
    private void copy(String imgPath, String path) {
        try {
            ...
            if (output.exists()) {
                if (!MessageDialog.openQuestion(JavaCIPUnknownScope.getShell(), "Overwrite", "There is already an image file " + input.getName() + " under the package.\n Do you really want to overwrite it?"))
                    return;
            }
            ...
            if (ijp != null) {
                ...
                JavaCIPUnknownScope.view.refresh();
                JavaCIPUnknownScope.view.expandAll();
            }
