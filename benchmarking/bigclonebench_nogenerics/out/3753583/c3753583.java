class c3753583 {
    ...
    public static void generateCode(File flowFile, String packagePath, File destDir, File scriptRootFolder) throws IORuntimeException {
        InputStream javaSrcIn = JavaCIPUnknownScope.generateCode(flowFile, packagePath, scriptRootFolder);
