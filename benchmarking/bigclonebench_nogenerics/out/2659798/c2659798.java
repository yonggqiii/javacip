class c2659798 {
    ...
    private void duplicateTable(Connection scon, Connection dcon, String table) {
        JavaCIPUnknownScope.logger.debug("Duplicating table " + table);
        ...
        try {
            ...
            creTab.execute(JavaCIPUnknownScope.getCreateTableCommand(columns, keys));
            ...
            JavaCIPUnknownScope.logger.debug("Insert pattern " + insert);
            ...
            JavaCIPUnknownScope.logger.error("Unable to copy table " + table + ": " + e);
            try {
                dcon.rollback();
