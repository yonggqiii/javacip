class c21368981 {
    ...
    public APIResponse create(Application application) throws RuntimeException {
        APIResponse response = new APIResponse();
        JavaCIPUnknownScope.connection = (HttpURLConnection) new URL(JavaCIPUnknownScope.url + "/api/application/create").openConnection();
        ...
        JavaCIPUnknownScope.marshaller.marshal(application, new MappedXMLStreamWriter(new MappedNamespaceConvention(new Configuration()), new OutputStreamWriter(JavaCIPUnknownScope.connection.getOutputStream(), "utf-8")));
        ...
        if (JavaCIPUnknownScope.connection.getResponseCode() == HttpURLConnection.HTTP_OK) {
            ...
            response.setMessage("Create Application Error Code: Http (" + JavaCIPUnknownScope.connection.getResponseCode() + ")");
        }
