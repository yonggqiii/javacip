class c3197089 {
    ...
    public void insertStringInFile(String file, String textToInsert, long fromByte, long toByte) throws RuntimeException {
        ...
        try {
            ...
            if (size == 0) {
                ...
                if ((length = in.read(buf)) != -1) {
                    ...
                    JavaCIPUnknownScope.logger.warning(msg);
            ...
            JavaCIPUnknownScope.logger.log(Level.WARNING, "Failed to read/write file '" + file + "'.", e);
            throw e;
        } finally {
            if (in != null) {
                try {
                    ...
                    JavaCIPUnknownScope.logger.log(Level.FINEST, "Ignoring error closing input file '" + file + "'.", e);
                }
            }
            if (out != null) {
                try {
                    ...
                    JavaCIPUnknownScope.logger.log(Level.FINEST, "Ignoring error closing output file '" + tmpFile + "'.", e);
                }
            }
        }
    }
