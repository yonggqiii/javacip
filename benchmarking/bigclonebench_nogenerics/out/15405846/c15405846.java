        ...
        try {
            ...
            if (sval1[0].equalsIgnoreCase("<Annotated>")) {
                ...
                if (isTrait || (isMarker && isNumeric)) {
                    ...
                    throw new IORuntimeException("Improperly formatted header. Data will not be imported.");
                }
            } else if ((line1.startsWith(">")) || (line1.startsWith(";"))) {
            ...
            JavaCIPUnknownScope.myLogger.info("guessAtUnknowns: type: " + guess);
            tds = JavaCIPUnknownScope.processDatum(filename, guess);
            br.close();
