class c13966304 {
    ...
    private void work(String[] args) throws RuntimeException {
        String dictLocation = JavaCIPUnknownScope.CONTENT_URL;
        String cpeContentDirName = JavaCIPUnknownScope.CONTENT_DIR;
