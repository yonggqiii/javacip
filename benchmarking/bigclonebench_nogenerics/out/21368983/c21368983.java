class c21368983 {
    ...
    public APIResponse update(Application application) throws RuntimeException {
        APIResponse response = new APIResponse();
        JavaCIPUnknownScope.connection = (HttpURLConnection) new URL(JavaCIPUnknownScope.url + "/api/application/update").openConnection();
        ...
        if (JavaCIPUnknownScope.connection.getResponseCode() == HttpURLConnection.HTTP_OK) {
            ...
            response.setMessage("Update Application Error Code: Http (" + JavaCIPUnknownScope.connection.getResponseCode() + ")");
        }
