class c20596006 {
    ...
    public APIResponse update(Item item) throws RuntimeException {
        APIResponse response = new APIResponse();
        JavaCIPUnknownScope.connection = (HttpURLConnection) new URL(JavaCIPUnknownScope.url + "/api/item/update").openConnection();
        ...
        if (JavaCIPUnknownScope.connection.getResponseCode() == HttpURLConnection.HTTP_OK) {
            ...
            response.setMessage("Update Item Error Code: Http (" + JavaCIPUnknownScope.connection.getResponseCode() + ")");
        }
