class c15225386 {
    ...
    public ActionForward sendTrackback(ActionMapping mapping, ActionForm actionForm, HttpServletRequest request, HttpServletResponse response) throws RollerRuntimeException {
        ...
        try {
            ...
            if (rreq.isUserAuthorizedToEdit()) {
                ...
                if (form.getTrackbackUrl() != null) {
                    try {
                        ...
                        JavaCIPUnknownScope.saveMessages(request, resultMsg);
                        wr.close();
                        rd.close();
            ...
            JavaCIPUnknownScope.mLogger.error(e);
        ...
        if (!errors.isEmpty()) {
            JavaCIPUnknownScope.saveErrors(request, errors);
        }
