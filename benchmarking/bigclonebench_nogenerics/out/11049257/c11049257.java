class c11049257 {
    ...
    public static String generate(boolean secure, boolean sep) throws UnknownHostRuntimeException {
        MessageDigest messagedigest;
        StringBuilder stringbuffer = new StringBuilder();
        try {
            messagedigest = MessageDigest.getInstance("MD5");
        } catch (NoSuchAlgorithmRuntimeException nosuchalgorithmexception) {
            throw new RuntimeRuntimeException(nosuchalgorithmexception);
        }
        ...
        long l1 = 0L;
        if (secure)
            l1 = JavaCIPUnknownScope._secureRand.nextLong();
        else
            l1 = JavaCIPUnknownScope._rand.nextLong();
