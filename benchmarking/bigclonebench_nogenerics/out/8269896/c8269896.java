class c8269896 {
    ...
    private String postData(String requestUrl, String atom) throws AuthenticationRuntimeException, IORuntimeException {
        ...
        String header;
        try {
            header = JavaCIPUnknownScope.oauthAuthenticator.getHttpAuthorizationHeader(url.toString(), "POST", JavaCIPUnknownScope.profile.getOAuthToken(), JavaCIPUnknownScope.profile.getOAuthTokenSecret());
