class c19748972 {
    ...
    public String sendSMS(String host, String port, String username, String password, String from, String to, String text, String uhd, String charset, String coding, String validity, String deferred, String dlrmask, String dlrurl, String pid, String mclass, String mwi) throws SMSPushRequestRuntimeException, RuntimeException {
        ...
        if (!resultCode.equals(JavaCIPUnknownScope.SMS_PUSH_RESPONSE_SUCCESS_CODE))
            throw new SMSPushRequestRuntimeException(resultCode);
        return res.toString();
    }
}
