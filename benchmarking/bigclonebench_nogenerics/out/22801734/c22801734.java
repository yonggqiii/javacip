class c22801734 {
    ...
    private static void setup() throws RuntimeException {
        ...
        if (!jarFile.exists())
            jarFile = new File("/home/marc/Virtual Machine/Hanasu.jar");
        ...
        String arch = "";
        boolean x64 = false;
        for (String key : JavaCIPUnknownScope.keys) {
        ...
        if (JPTrayIcon.isWindows()) {
            ...
            if (x64 && !System.getProperty("sun.arch.data.model").equals("32"))
                arch = "win64-amd64";
            else
                arch = "win32-x86";
        }
        ...
        JavaCIPUnknownScope.addLibraryPath(parent + "native/" + arch + "/");
    }
}
