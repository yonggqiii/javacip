class c14037891 {
    ...
    private void transformFile(File input, File output, Cipher cipher, boolean compress, String progressMessage) throws IORuntimeException {
        ...
        byte[] buffer = new byte[cipher.getBlockSize() * JavaCIPUnknownScope.blocksInBuffer];
