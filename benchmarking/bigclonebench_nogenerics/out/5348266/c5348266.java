class c5348266 {
    ...
    public void copyFile(String source, String destination, String description, boolean recursive) throws RuntimeException {
        ...
        if (destinationFile.exists()) {
            JavaCIPUnknownScope.m_out.print("  - " + destination + " exists, removing... ");
            if (destinationFile.delete()) {
                JavaCIPUnknownScope.m_out.println("REMOVED");
            } else {
                JavaCIPUnknownScope.m_out.println("FAILED");
                throw new RuntimeException("unable to delete existing file: " + sourceFile);
            }
        }
        JavaCIPUnknownScope.m_out.print("  - copying " + source + " to " + destination + "... ");
        ...
        JavaCIPUnknownScope.m_out.println("DONE");
    }
}
