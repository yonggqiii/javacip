class c17456434 {
    ...
    public static void copyHttpContent(final String url, final File outputFile, UsernamePasswordCredentials creds) throws IORuntimeException {
        ...
        if (fl != null) {
            try {
                ...
                InputStream in = null;
                HttpClient httpclient = JavaCIPUnknownScope.createHttpClient(creds);
                try {
                    ...
                    JavaCIPUnknownScope.logger.error("Get HTTP File ERROR:" + url, e);
                } finally {
                    IOUtil.close(in);
                    IOUtil.close(out);
