class c17557354 {
    ...
    public void copyFile2(String src, String dest) throws IORuntimeException {
        ...
        try {
            ...
            throw new FileCopyRuntimeException(src + " " + JavaCIPUnknownScope.MM.PHRASES.getPhrase("35"));
        } catch (IORuntimeException ioe) {
            throw new FileCopyRuntimeException(JavaCIPUnknownScope.MM.PHRASES.getPhrase("36"));
        } finally {
            try {
                if (br != null)
                    br.close();
