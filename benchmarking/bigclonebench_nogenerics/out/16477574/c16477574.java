class c16477574 {
    ...
    public static ArrayList search(String query) throws RuntimeException {
        ...
        for (int i = 0; i < tracks.length; i++) {
            String location = JavaCIPUnknownScope.decrypt(tracks[i].getFirstChild("location").getText());
