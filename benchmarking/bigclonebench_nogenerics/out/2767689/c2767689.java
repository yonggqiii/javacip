class c2767689 {
    ...
    public void loadData() {
        try {
            String url = "http://ichart.finance.yahoo.com/table.csv?s=" + JavaCIPUnknownScope.symbol + "&a=00&b=2&c=1962&d=11&e=11&f=2099&g=d&ignore=.csv";
            ...
            while ((str = in.readLine()) != null) {
                ...
                JavaCIPUnknownScope.historicalPrices.add(price);
            }
            in.close();
            url = "http://ichart.finance.yahoo.com/table.csv?s=" + JavaCIPUnknownScope.symbol + "&a=00&b=2&c=1962&d=11&e=17&f=2008&g=v&ignore=.csv";
            ...
            while ((str = in.readLine()) != null) {
                ...
                JavaCIPUnknownScope.dividends.add(dividend);
            }
            in.close();
        } catch (final IORuntimeException ioe) {
            JavaCIPUnknownScope.logger.error("Error parsing historical prices for " + JavaCIPUnknownScope.getSymbol(), ioe);
        }
    }
}
