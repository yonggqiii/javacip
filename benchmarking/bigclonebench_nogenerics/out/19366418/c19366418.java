class c19366418 {
    ...
    public static Photo createPhoto(String title, String userLogin, String pathToPhoto, String basePathImage) throws NoSuchAlgorithmRuntimeException, IORuntimeException {
