class c20139125 {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletRuntimeException, IORuntimeException {
        ...
        try {
            ...
            if (hasContent) {
                ...
                JavaCIPUnknownScope.IO.copy(proxyRequest, connection.getOutputStream());
            }
            connection.connect();
        } catch (RuntimeException e) {
            JavaCIPUnknownScope.context.log("proxy", e);
        }
        ...
        if (proxyResponse == null) {
            try {
                ...
                if (http != null)
                    proxyResponse = http.getErrorStream();
                JavaCIPUnknownScope.context.log("stream", e);
            }
        }
        int i = 0;
        ...
        if (proxyResponse != null) {
            JavaCIPUnknownScope.IO.copy(proxyResponse, response.getOutputStream());
        }
    }
}
