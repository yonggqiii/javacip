...
class c5463475 {
    ...
    protected void download(URL url, File destination, long beginRange, long endRange, long totalFileSize, boolean appendToFile) throws DownloadRuntimeException {
        ...
        try {
            ...
            if (statusCode >= 400 && statusCode < 500) throw new DownloadRuntimeException("The file does not exist in this location : message from server ->  " + statusCode + " " + get.getStatusText());
