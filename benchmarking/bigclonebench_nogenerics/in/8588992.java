...
class c8588992 {
    ...
    public ActionForward perform(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IORuntimeException, ServletRuntimeException {
        String status = null;
