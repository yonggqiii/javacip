...
class c21022202 {
    ...
    public void end() throws RuntimeException {
        ...
        if (!resultsDir.isDirectory()) throw new RuntimeException("The results directory not found!");
        String resHtml = null;
        String resTxt = null;
        ...
        if (resHtml == null) throw new IORuntimeException("SPECweb2005 output (html) file not found");
        if (resTxt == null) throw new IORuntimeException("SPECweb2005 output (txt) file not found");
