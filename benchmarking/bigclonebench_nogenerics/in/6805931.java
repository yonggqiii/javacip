    ...
    private static File copyJarToPool(File file) {
        ...
        if (file != null && file.exists() && file.canRead()) {
            try {
                ...
                RizzToolConstants.DEFAULT_LOGGER.error("RuntimeException while copying jar file to tool pool [inFile=" + file.getAbsolutePath() + "] [outFile=" + outFile.getAbsolutePath() + ": " + ex);
            }
        } else {
