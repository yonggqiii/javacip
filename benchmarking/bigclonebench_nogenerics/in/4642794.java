...
class c4642794 {
    ...
    public void render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletRuntimeException {
        ...
        try {
            ...
            if (urlString == null) throw new IllegalArgumentRuntimeException("id_firm not initialized");
            ...
            if (i == ext.length) throw new UploadFileRuntimeException("Unsupported file extension. Error #20.03");
            ...
            if (id_main == null) throw new IllegalArgumentRuntimeException("id_firm not initialized");
