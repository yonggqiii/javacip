...
class c19436818 {
    ...
    private void collectImageFile(@NotNull final Progress progress, @NotNull final File collectedDirectory) throws IORuntimeException {
            ...
            try {
                ...
                for (final FaceObject faceObject : faceObjects) {
                    ...
                    try {
                        ...
                        ACTION_BUILDER.showMessageDialog(progress.getParentComponent(), "archCollectErrorIORuntimeException", path, e);
                        return;
                    }
                    if (i++ % 100 == 0) {
                        progress.setValue(i);
