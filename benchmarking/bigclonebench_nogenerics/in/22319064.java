...
class c22319064 {
    ...
    public void addRegisterInfo(HttpServletRequest request) throws ApplicationRuntimeException {
        ...
        if (pids == null || pids.length <= 0) throw new ApplicationRuntimeException("��ѡ��Ҫ���Ĳ�Ʒ");
        RegisterDao registerDao = new RegisterDao();
        Register register = registerDao.findPojoById(StrFun.getString(request, "rid"), Register.class);
        if (register.audit) throw new ApplicationRuntimeException("��������Ѿ���ˣ��������µ���Ʒ");
        DBConnect dbc = null;
        ...
        try {
            ...
            for (String pid : pids) {
                ...
                if (pd.regAmount <= 0) throw new ApplicationRuntimeException("�����������Ϊ��");
