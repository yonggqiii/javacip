...
class c14651403 {
    ...
    public ICCColorSpaceExt createICCColorSpaceExt(BridgeContext ctx, Element paintedElement, String iccProfileName) {
        ...
        if (href != null) {
            ...
            if (!purl.complete()) throw new BridgeRuntimeException(paintedElement, ERR_URI_MALFORMED, new Object[] { href });
            try {
                ...
                throw new BridgeRuntimeException(paintedElement, ERR_URI_IO, new Object[] { href });
            } catch (SecurityRuntimeException e) {
                throw new BridgeRuntimeException(paintedElement, ERR_URI_UNSECURE, new Object[] { href });
            }
        }
        if (p == null) {
            return null;
