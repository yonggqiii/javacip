...
class c11540200 {
    ...
    public File uploadImage(InputStream inputStream, String fileName, String sessionId) {
        ...
        try {
            ...
            logger.error("Save uploaded image to file occur IORuntimeException.", e);
            ...
            try {
                ...
                logger.error("Close FileOutputStream Occur IORuntimeException while save a uploaded image.", e);
            }
        }
        return file;
    }
