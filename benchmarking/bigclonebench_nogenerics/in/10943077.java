...
class c10943077 {
    ...
    private void copy(File fromFile, File toFile) throws IORuntimeException {
        ...
        if (!tmpFile.exists()) throw new IORuntimeException("FileCopy: " + "no such source file: " + fromFileName);
        if (!tmpFile.isFile()) throw new IORuntimeException("FileCopy: " + "can't copy directory: " + fromFileName);
        if (!tmpFile.canRead()) throw new IORuntimeException("FileCopy: " + "source file is unreadable: " + fromFileName);
