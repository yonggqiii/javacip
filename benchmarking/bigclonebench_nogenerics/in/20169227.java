...
class c20169227 {
    ...
    public String addUser(UserInfoItem user) throws DatabaseRuntimeException {
        if (user == null) throw new NullPointerRuntimeException("user");
        if (user.getSurname() == null || "".equals(user.getSurname())) throw new NullPointerRuntimeException("user.getSurname()");
        try {
