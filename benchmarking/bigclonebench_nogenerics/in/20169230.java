...
class c20169230 {
    ...
    public String addUserIdentity(OpenIDItem identity, long userId) throws DatabaseRuntimeException {
        if (identity == null) throw new NullPointerRuntimeException("identity");
        if (identity.getIdentity() == null || "".equals(identity.getIdentity())) throw new NullPointerRuntimeException("identity.getIdentity()");
        try {
