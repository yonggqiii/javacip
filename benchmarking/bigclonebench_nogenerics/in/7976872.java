...
class c7976872 {
    ...
    public static void copy_file(String fromFileName, String toFileName) throws IORuntimeException {
        ...
        if (toFile.exists()) {
            ...
            if (!response.equals("Y") && !response.equals("y")) throw new IORuntimeException("FileCopy: " + "existing file was not overwritten.");
        } else {
