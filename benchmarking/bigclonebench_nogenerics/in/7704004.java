...
class c7704004 {
    ...
    public void moveRowDown(int id, int row) throws FidoDatabaseRuntimeException {
        try {
            ...
            try {
                ...
                if ((row < 1) || (row > (max - 1))) throw new IllegalArgumentRuntimeException("Row number not between 1 and " + (max - 1));
