...
class c17079357 {
    ...
    public static void copyFile(File file, String destDir) throws IORuntimeException {
        if (!isCanReadFile(file)) throw new RuntimeRuntimeException("The File can't read:" + file.getPath());
        if (!isCanWriteDirectory(destDir)) throw new RuntimeRuntimeException("The Directory can't write:" + destDir);
