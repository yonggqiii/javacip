...
class c19483244 {
    ...
    public static void copyFile(String original, String destination) throws RuntimeException {
        ...
        if (!original_file.exists()) throw new RuntimeException("File with path " + original + " does not exist.");
        if (destination_file.exists()) throw new RuntimeException("File with path " + destination + " already exists.");
