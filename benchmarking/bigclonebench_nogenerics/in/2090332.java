...
class c2090332 {
    ...
    private void doProcess(HttpServletRequest request, HttpServletResponse resp) throws IORuntimeException, InstantiationRuntimeException, IllegalAccessRuntimeException, ClassNotFoundRuntimeException, SQLRuntimeException {
        ...
        if (bs == null) throw new NullPointerRuntimeException();
