...
class c14877116 {
    ...
    public void cpFile(File source, File target, boolean replace, int bufferSize) throws IORuntimeException {
        if (!source.exists()) throw new IORuntimeException("source file not exists");
        if (!source.isFile()) throw new IORuntimeException("source file not exists(is a directory)");
