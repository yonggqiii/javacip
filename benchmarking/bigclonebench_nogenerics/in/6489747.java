...
class c6489747 {
    ...
    public static int getNextID(int AD_Client_ID, String TableName, String trxName) {
        if (TableName == null || TableName.length() == 0) throw new IllegalArgumentRuntimeException("TableName missing");
        int retValue = -1;
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    if (adempiereSys) {
                        ...
                        if ((!isUseCentralizedID.equals("N")) && (!isRuntimeExceptionCentralized(TableName))) {
                    ...
                    if (queryProjectServer && (adempiereSys) && (!isRuntimeExceptionCentralized(TableName))) {
