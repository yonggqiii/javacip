...
class c2525684 {
    ...
    private void add(Hashtable applicantInfo) throws RuntimeException {
        ...
        if ("".equals(getParam("applicant_name"))) throw new RuntimeException("Can not have empty fields!");
        ...
        try {
            ...
            if (found && !"update".equals(mode)) throw new RuntimeException("Applicant Id was invalid!");
            {
                r.clear();
