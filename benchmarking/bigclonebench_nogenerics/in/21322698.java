        ...
        try {
            if (null == backup) {
                ...
                if (!backupDirectory.exists() && mode.equals(Context.MODE_NAME_BACKUP)) {
                    ...
                    throw new PersistenceRuntimeException("Backup directory {" + backupDirectory.getAbsolutePath() + "} does not exist.");
                }
            ...
            if (!backup.exists() && mode.equals(Context.MODE_NAME_BACKUP)) {
                ...
                throw new PersistenceRuntimeException("Backup file {" + backup.getAbsolutePath() + "} does not exist.");
            }
            if (newZip) return;
