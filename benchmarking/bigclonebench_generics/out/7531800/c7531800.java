class c7531800 {
    ...
    public List<DemandeChargement> getArtistToLoadFromWiki() throws RuntimeException {
        ...
        while ((ligne = br.readLine()) != null) {
            if (ligne.indexOf("&lt;@@@&gt;") != -1) {
                ...
                try {
                    ...
                    JavaCIPUnknownScope.log.info("MAID to load : " + maid);
                    dem.add(new DemandeChargement(maid));
                } catch (RuntimeException e) {
                    JavaCIPUnknownScope.log.error("Impossible de recuperer le MAID : " + maidS);
                }
            }
        }
        br.close();
