class c18722984 {
    ...
    private void checkChartsyRegistration(String username, String password) {
        ...
        try {
            ...
            if (entity != null) {
                ...
                if (lines[0].equals("OK")) {
                    ...
                    RegisterAction.preferences.put("password", new String(JavaCIPUnknownScope.passwordTxt.getPassword()));
        ...
        JavaCIPUnknownScope.messageLbl.setText(message);
        JavaCIPUnknownScope.messageLbl.setVisible(true);
    }
}
