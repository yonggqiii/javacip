class c15495362 {
    ...
    public int batchTransactionUpdate(List<String> queryStrLisyt, Connection con) throws RuntimeException {
        int ret = 0;
        Statement stmt;
        if (con != null) {
            ...
            try {
                ...
                for (int i = 0; i < updateCounts.length; i++) {
                    ...
                    if (updateCounts[i] == Statement.SUCCESS_NO_INFO || updateCounts[i] > 0) {
                        ...
                        ;
                    {
                        throw new RuntimeException("query failed, while process batch update");
                    }
                }
                con.commit();
