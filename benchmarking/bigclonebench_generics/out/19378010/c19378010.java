class c19378010 {
    ...
    public static Multimap<String, String> getProteins(final Set<String> queries, final int taxon) throws ParserConfigurationRuntimeException, XPathExpressionRuntimeException {
        final DocumentBuilder parser = DocumentBuilderFactory.newInstance().newDocumentBuilder();
        final XPathExpression xpe = XPathFactory.newInstance().newXPath().compile(JavaCIPUnknownScope.__xpath);
        ...
        for (final String query : queries) {
            ...
            try {
                ...
                final URL url = new URL(String.format(JavaCIPUnknownScope.__urlTempl2, encoded, taxon));
