class c13456572 {
    ...
    public void transferOutputFiles() throws IORuntimeException {
        HashSet<GridNode> nodes = (HashSet) JavaCIPUnknownScope.batchTask.returnNodeCollection();
        ...
        while (ic.hasNext()) {
            ...
            if (hostname.getHostName().equals(hostnameLocal))
                continue;
            String[] usernamePass = JavaCIPUnknownScope.inputNodes.get(hostname.getHostName());
