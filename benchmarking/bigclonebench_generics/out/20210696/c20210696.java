class c20210696 {
    ...
    public Long postEdit(final HttpPost post, final String content, final Pattern pattern) throws RequestTrackerRuntimeException {
        String rtTicketNumber = null;
        final List<NameValuePair> params = new ArrayList<NameValuePair>();
        params.add(new BasicNameValuePair("user", JavaCIPUnknownScope.m_user));
        params.add(new BasicNameValuePair("pass", JavaCIPUnknownScope.m_password));
        ...
        try {
            final HttpResponse response = JavaCIPUnknownScope.getClient().execute(post);
            ...
            throw new RequestTrackerRuntimeException(e);
        }
