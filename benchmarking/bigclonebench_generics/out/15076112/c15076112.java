class c15076112 {
    ...
    public JSONObject getJsonObj(Trip trip, List<Waypoint> stops) throws IORuntimeException {
        ...
        try {
            ...
            JavaCIPUnknownScope.logger.error("Problem with initializing JSONObject", e);
        }
        return jsonObject;
    }
}
