class c16553582 {
    ...
    public QueryResult doSearch(String searchTerm, Integer searchInReceivedItems, Integer searchInSentItems, Integer searchInSupervisedItems, Integer startRow, Integer resultCount, Boolean searchArchived, Boolean searchInItemsNeededAttentionOnly) throws UnsupportedEncodingException, IOException {
        ...
        JavaCIPUnknownScope.log(JavaCIPUnknownScope.INFO, "searchTerm=" + searchTerm);
        JavaCIPUnknownScope.log(JavaCIPUnknownScope.INFO, "search in received=" + searchInReceivedItems);
        JavaCIPUnknownScope.log(JavaCIPUnknownScope.INFO, "search in sent=" + searchInSentItems);
        JavaCIPUnknownScope.log(JavaCIPUnknownScope.INFO, "search in supervised=" + searchInSupervisedItems);
