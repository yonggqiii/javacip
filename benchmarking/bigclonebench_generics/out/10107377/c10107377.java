class c10107377 {
    ...
    public static Collection<SearchKeyResult> searchKey(String iText, String iKeyServer) throws Exception {
        ...
        String uri = iKeyServer + "/pks/lookup?search=" + URLEncoder.encode(iText, JavaCIPUnknownScope.UTF8);
        URL url = new URL(uri);
        ...
        while ((line = input.readLine()) != null) {
            ...
            while (regexMatcher.find()) {
                ...
                String name = JavaCIPUnknownScope.decodeHTML(regexMatcher.group(4));
