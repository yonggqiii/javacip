class c13075309 {
    ...
    public static void loginBayFiles() throws RuntimeException {
        ...
        while (it.hasNext()) {
            ...
            if (escookie.getName().equalsIgnoreCase("SESSID")) {
                JavaCIPUnknownScope.sessioncookie = "SESSID=" + escookie.getValue();
                System.out.println(JavaCIPUnknownScope.sessioncookie);
