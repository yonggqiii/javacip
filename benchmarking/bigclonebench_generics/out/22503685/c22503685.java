class c22503685 {
    ...
    public static Collection<Tuple<String, ArrayList<String>>> readGeoParserResult(String recordContent, boolean getGazeteerIds) {
        if (JavaCIPUnknownScope.TESTING) {
        ...
        while (retries < 3) {
            try {
                ...
                URL url = new URL(JavaCIPUnknownScope.geoParserBaseUrl + "?request=" + URLEncoder.encode(doc.asXML(), "ISO8859-1"));
                ...
                JavaCIPUnknownScope.log.debug("Erro ao pesquisar a lista de termos para o registo " + recordContent + "! " + e.getMessage(), e);
