        ...
        try {
            ...
            while (scan.hasNextLine()) {
                ...
                if (temp.contains("<td style='padding-top:4px;' class='ergebnisse_res'>")) {
                    ...
                    if (JavaCIPUnknownScope.searchEnglish == false && JavaCIPUnknownScope.searchGerman == false) {
                        JavaCIPUnknownScope.searchEnglish = temp.contains("<td style='' class='ergebnisse_art'>");
                        JavaCIPUnknownScope.searchGerman = temp.contains("<td style='' class='ergebnisse_art_dif'>");
                    }
                    ...
                    str += translate + " - " + temp + "\n";
                    JavaCIPUnknownScope.germanList.add(translate);
                    JavaCIPUnknownScope.englishList.add(temp.trim());
                }
            }
            if (JavaCIPUnknownScope.searchEnglish) {
                List<String> temp2 = JavaCIPUnknownScope.englishList;
                JavaCIPUnknownScope.englishList = JavaCIPUnknownScope.germanList;
                JavaCIPUnknownScope.germanList = temp2;
            }
