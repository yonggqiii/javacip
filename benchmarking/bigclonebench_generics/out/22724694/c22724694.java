class c22724694 {
    ...
    public List<MytemHistory> getMytemHistories(String janCode) throws GaeException {
        ...
        StringBuffer request = new StringBuffer(JavaCIPUnknownScope.address);
        ...
        try {
            ...
            if (statusCode == JavaCIPUnknownScope.NOT_FOUND) {
                return null;
            }
            if (statusCode >= 400) {
            ...
            return JavaCIPUnknownScope.createMytemHistories(builder.toString());
