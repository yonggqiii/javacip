class c5378327 {
    ...
    public static synchronized Map<String, Object> getURLContentMap(String wwwurl) throws IORuntimeException, URISyntaxRuntimeException {
        ...
        try {
            ...
            synchronized (instream) {
                ...
                while ((readSize = instream.read(buffer)) > 0) {
                    ...
                    totalSize += readSize;
                    if (totalSize >= JavaCIPUnknownScope.MAX_CONTENT_SIZE) {
                        contentByte = ("[FAILD] content size is larger than " + JavaCIPUnknownScope.MAX_CONTENT_SIZE + " byte.").getBytes();
                    }
                }
                if (contentByte == null) {
                ...
                instream.close();
                outstream.close();
                resultMap.put(JavaCIPUnknownScope.contentByteField, contentByte);
            }
        } finally {
        }
        return resultMap;
