    ...
    public static String httpGetJson(final List<NameValuePair> nameValuePairs) {
        ...
        try {
            ...
            if (JavaCIPUnknownScope.HTTPS) {
                ...
                uri = new URI(JavaCIPUnknownScope.DEADDROPS_SERVER_URL_HTTPS + "?" + paramString);
            } else {
                httpclient = new DefaultHttpClient();
                uri = new URI(JavaCIPUnknownScope.DEADDROPS_SERVER_URL + "?" + paramString);
            }
